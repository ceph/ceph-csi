...
| `nodeplugin.registrar.image.tag`               | Image tag                                                                                                                                            | `v2.18.0`                                           |
...
| `provisioner.attacher.image.tag`               | Specifies image tag                                                                                                                                  | `v4.13.0`                                           |
...
| `provisioner.resizer.image.tag`                | Specifies image tag                                                                                                                                  | `v2.2.1`                                           |
...
| `storageClass.controllerPublishSecret`         | Specifies the controller publish secret name                                                                                                         | `csi-cephfs-secret`                                |
