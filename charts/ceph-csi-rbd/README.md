...
| `provisioner.provisioner.image.tag`            | Specifies image tag                                                                                                                                  | `v5.3.0`                                           |
...
| `provisioner.attacher.image.tag`               | Specifies image tag                                                                                                                                  | `v4.9.0`                                           |
...
| `provisioner.resizer.image.tag`                | Specifies image tag                                                                                                                                  | `v1.14.0`                                           |
...
| `provisioner.snapshotter.image.tag`            | Specifies image tag                                                                                                                                  | `v8.3.0`                                           |
