...
func init() {
	...
	flag.BoolVar(&testCephFSFscrypt, "test-cephfs-fscrypt", true, "test CephFS csi driver fscrypt support")
	flag.BoolVar(&testRBD, "test-rbd", true, "test rbd csi driver")
	flag.BoolVar(&testRBDFSCrypt, "test-rbd-fscrypt", true, "test rbd csi driver fscrypt support")
