...
type NonBlockingGRPCServer interface {
	...
	Start(endpoint string, srv Servers, metrics bool)
...
func (s *nonBlockingGRPCServer) Start(endpoint string, srv Servers, metrics bool) {
	s.wg.Add(1)
	go s.serve(endpoint, srv, metrics)
}
...
func (s *nonBlockingGRPCServer) serve(endpoint string, srv Servers, metrics bool) {
